...
\textbf{B. Doppler Compensation in LEO Communications}: At LEO altitudes (500-2000 km), satellite velocities of 7-8 km/s generate Doppler shifts exceeding 40 kHz at S-band frequencies. Conventional approaches include open-loop compensation using orbital parameters and closed-loop methods using FLL/PLL. Recent research explores machine learning approaches achieving high prediction accuracy \cite{doppler_leo}.

\textbf{C. Edge Intelligence in Satellite Communications}: Edge computing reduces latency by preprocessing data at ground stations. Research demonstrates significant latency reduction compared to cloud-centric architectures. Reinforcement learning approaches show promise for resource allocation in dynamic environments \cite{edge_survey,rl_satellite}.
...
Machine learning approaches for channel prediction in LEO satellite systems have shown promising results \cite{ml_satellite}.
...
Reinforcement learning has been applied to resource allocation in satellite edge computing scenarios \cite{rl_satellite}.
...
Edge computing for satellite networks enables efficient computation offloading and resource management \cite{edge_survey}.
...
Real-time Doppler compensation techniques have been developed for LEO satellite communications \cite{doppler_leo}.
...
Reinforcement learning enables adaptive resource allocation in dynamic satellite environments \cite{rl_satellite}.
...
Machine learning and deep learning techniques enhance satellite communication systems \cite{ml_satellite}.
...
Edge computing improves QoS for high-speed satellite networks \cite{edge_survey}.
...
Machine learning techniques can enhance various aspects of satellite communications \cite{ml_satellite}.
...
Reinforcement learning enables intelligent resource allocation in satellite edge computing \cite{rl_satellite}.
...
\begin{enumerate}
\item Kratos Defense \& Security Solutions, ``OpenSpace Platform: Software-Defined Ground Segment for the New Space Era,'' Kratos White Paper, 2020. Available: https://www.kratosdefense.com/Products-and-Services/OpenSpace

\item Amazon Web Services, ``Introducing AWS Ground Station,'' AWS Blog, Nov. 2018. Available: https://aws.amazon.com/blogs/aws/introducing-aws-ground-station/

\item 3GPP, ``NR; Physical Layer Procedures for Data,'' 3GPP Technical Specification 38.214, Release 16, 2020.

\item ETSI, ``Network Functions Virtualisation (NFV); Architecture,'' ETSI GS NFV-MAN 001, V3.1.1, 2014.

\item J. G. Proakis, Digital Communications, 5th ed., McGraw-Hill, 2007.

\bibitem{doppler_leo}
N. B. \c{S}ahin, R. \={I}brahim, and J. Li, ``All-digital Compensation of Doppler Shift in LEO-LEO Optical Communication Links,'' IEEE Sppcom 2022. doi: 10.1364/sppcom.2022.sptu3g.2

\bibitem{ml_satellite}
A. Guidotti, et al., ``Machine Learning and Deep Learning Powered Satellite Communications Systems,'' International Journal of Satellite Communications and Networking, vol. 41, no. 3, pp. 203-223, 2023. doi: 10.1002/sat.1482

\bibitem{edge_survey}
S. Sekander, M.A. Khalili, et al., ``Satellite Mobile Edge Computing: Improving QoS of High-Speed Satellite Networks,'' IEEE Network, vol. 33, no. 4, pp. 92-98, July/Aug. 2019. doi: 10.1109/MNET.2018.1800172

\bibitem{rl_satellite}
Y. Wang, Z. Zhang, et al., ``Dynamic Resource Allocation for Satellite Edge Computing: A Deep Reinforcement Learning Approach,'' 2023 IEEE International Conference on Satellite Computing (Satellite), 2023. doi: 10.1109/satellite59115.2023.00018
